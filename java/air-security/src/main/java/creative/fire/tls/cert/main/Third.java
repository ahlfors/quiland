...
public class Third {
	public static void main(String[] args) throws Exception {
		...
		CertHandle.trustCACert(ICM_ALIAS, ICM_SIGN_CER, ICM_KEYSTORE);
		// im.importSign("opposite", UCGW_SIGN_CER, ICM_KEYSTORE);

		CertHandle.importCert(CA_ALIAS, CA_CER, UCGW_KEYSTORE);
		CertHandle.trustCACert(UCGW_ALIAS, UCGW_SIGN_CER, UCGW_KEYSTORE);
		// im.importSign("opposite", ICM_SIGN_CER, UCGW_KEYSTORE);
