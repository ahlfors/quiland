...
import feuyeux.io.file.FilePath;
...
public class TestAttributes {
    ...
    final Path path = Paths.get(filePath.getClassDir2() + "resource", ENV.TESTING_FILE_1);
    ...
    public void testACLView() {
        ...
        try {
            aclEntryList = aclFileAttributeView.getAcl();
        } catch (IOException e) {
            logger.error(e);
        }
