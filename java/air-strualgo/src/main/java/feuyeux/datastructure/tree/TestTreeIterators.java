...
import feuyeux.datastructure.array.ArrayQueue;
import feuyeux.datastructure.array.ArrayStack;
import feuyeux.datastructure.array.Queue;
import feuyeux.datastructure.array.Stack;
...
abstract class TreeIterator<AnyType> {
     ...
     */
    public TreeIterator(final BinaryTree<AnyType> theTree) {
        t = theTree;
        current = null;
    }
    ...
    /**
     * Advance the current position to the next node in the tree, according to the traversal
     * scheme. If the current position is null, then throw an exception. This is the alternate
     * strategy, that we did not use for lists.
     * 
     * @throws NoSuchElementException
...
class PostOrder<AnyType> extends TreeIterator<AnyType> {
     ...
     * the tree to which the iterator is permanently bound.
     */
    public PostOrder(final BinaryTree<AnyType> theTree) {
        super(theTree);
    ...
    /**
     * Advance the current position to the next node in the tree, according to the postorder
     * traversal scheme.
     * 
     * @throws NoSuchElementException
    ...
    protected static class StNode<AnyType> {
        ...
        StNode(final BinaryNode<AnyType> n) {
            node = n;
            timesPopped = 0;
        }
    }
...
class InOrder<AnyType> extends PostOrder<AnyType> {
     ...
     * the tree to which the iterator is permanently bound.
     */
    public InOrder(final BinaryTree<AnyType> theTree) {
        super(theTree);
    }

    /**
     * Advance the current position to the next node in the tree, according to the inorder
     * traversal scheme.
     * 
     * @throws NoSuchElementException
     * if iteration has been exhausted prior to the call.
...
class PreOrder<AnyType> extends TreeIterator<AnyType> {
     ...
     * the tree to which the iterator is permanently bound.
     */
    public PreOrder(final BinaryTree<AnyType> theTree) {
        super(theTree);
    ...
    /**
     * Advance the current position to the next node in the tree, according to the preorder
     * traversal scheme.
     * 
     * @throws NoSuchElementException
     * if iteration has been exhausted prior to the call.
    ...
    private final Stack<BinaryNode<AnyType>> s; // Stack of BinaryNode objects
}
...
class LevelOrder<AnyType> extends TreeIterator<AnyType> {
     ...
     * the tree to which the iterator is permanently bound.
     */
    public LevelOrder(final BinaryTree<AnyType> theTree) {
        super(theTree);
    ...
    /**
     * Set the current position to the first item, according to the level-order traversal
     * scheme.
     */
    @Override
    public void first() {
    ...
    /**
     * Advance the current position to the next node in the tree, according to the level-order
     * traversal scheme.
     * 
     * @throws NoSuchElementException
     * if iteration has been exhausted prior to the call.
    ...
    private final Queue<BinaryNode<AnyType>> q; // Queue of BinaryNode objects
}
...
public class TestTreeIterators {
    ...
    public static void main(final String[] args) {
        ...
        final BinaryTree<Integer> t1 = new BinaryTree<Integer>(1);
        final BinaryTree<Integer> t3 = new BinaryTree<Integer>(3);
        final BinaryTree<Integer> t5 = new BinaryTree<Integer>(5);
        final BinaryTree<Integer> t7 = new BinaryTree<Integer>(7);
        final BinaryTree<Integer> t2 = new BinaryTree<Integer>();
        final BinaryTree<Integer> t4 = new BinaryTree<Integer>();
        final BinaryTree<Integer> t6 = new BinaryTree<Integer>();
    ...
    public static <AnyType> void testItr(final String type, final TreeIterator<AnyType> itr) {
        try {
