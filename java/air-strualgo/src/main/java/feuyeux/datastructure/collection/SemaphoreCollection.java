package feuyeux.datastructure.collection;
...
public class SemaphoreCollection<E> {
    ...
    public static void main(final String[] ss) throws InterruptedException {
        final SemaphoreCollection<Integer> buffer = new SemaphoreCollection<Integer>(2);
        buffer.put(1);
        System.out.println("---- ----");
        buffer.put(2);
        System.out.println("---- ----");
