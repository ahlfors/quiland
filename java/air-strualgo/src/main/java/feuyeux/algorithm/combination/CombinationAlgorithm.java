package feuyeux.algorithm.combination;
...
public class CombinationAlgorithm {
    ...
    public static void main(final String arf[]) {
        final CombinationAlgorithm demo = new CombinationAlgorithm();
    ...
    public void recursion(final int sourceIndex, final int targetIndex) {
