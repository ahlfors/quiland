...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    dispatch_async(queue, ^{
        ...
        NSLog(@"GCD多线程");
        for (int i = 0; i < 100; i++) {
            [worker fill:[NSString stringWithFormat:@"%d", i]];
        }
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MultipleT" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MultipleT.sqlite"];
